...
VALUE main_rb(VALUE data) {
  ...
  rb_eval_string(
      ...
      "end\n"
      "class Window\n"
      "  attr_unimplemented :active, :arrows_visible, :back_opacity, :contents, :contents_opacity, :cursor_rect, :opacity, :openness, :oy, :padding, :padding_bottom, :pause, :tone\n"
      "  def openness=(newval)\n"
      "    warn_unimplemented(\"Window#openness\")\n"
